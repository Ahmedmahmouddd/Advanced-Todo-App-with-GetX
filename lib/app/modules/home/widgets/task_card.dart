      ...
      child: Column(
        ...
        children: [
          ...
          StepProgressIndicator(
            ...
            currentStep: 3,
            size: 6,
            roundedEdges: Radius.circular(50.0),
            padding: 0,
            ...
            child: Column(
              ...
              children: [
                Text(
                  task.title,
                  style:
                      TextStyle(fontSize: 16.0, fontWeight: FontWeight.bold, overflow: TextOverflow.ellipsis),
                ),
                Text(
                  task.todos?.length == 1 ? "${task.todos?.length} task" : "${task.todos?.length ?? 0} tasks",
